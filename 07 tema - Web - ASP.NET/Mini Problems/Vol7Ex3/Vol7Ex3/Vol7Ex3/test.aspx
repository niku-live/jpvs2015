<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test.aspx.cs" Inherits="Vol7Ex3.test" %>
...
<body>
    ...
    <div>
        ...
        <br />
        <asp:GridView ID="GridView1" runat="server" DataSourceID="XmlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None">
